	...
	var ms = {
		...
		fillHtml:function(obj,args){
			return (function(){
				...
				//第一页
				/*if(args.current > 1){
					obj.append('<a href="javascript:;" class="firstPage">第一页</a>');
				}else{
					obj.remove('.prevPage');
					obj.append('<span class="disabled">第一页</span>');
				}*/
				//上一页
				if(args.current > 1){
				...
				//第一页
				/*if(args.current < args.pageCount){
					obj.append('<a href="javascript:;" class="lastPage">最后一页</a>');
				}else{
					obj.remove('.nextPage');
					obj.append('<span class="disabled">最后一页</span>');
				}*/
